...
/**
 * This is the item provider adapter for a {@link org.mdse.minisql.schema.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchemaPackage.Literals.TABLE__COLUMNS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case SchemaPackage.TABLE__COLUMNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.TABLE__COLUMNS,
				 SchemaFactory.eINSTANCE.createColumn()));
	}
