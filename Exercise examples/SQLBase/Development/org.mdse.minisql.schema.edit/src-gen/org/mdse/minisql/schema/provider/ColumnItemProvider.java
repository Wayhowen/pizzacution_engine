/**
 */
package org.mdse.minisql.schema.provider;
...
/**
 * This is the item provider adapter for a {@link org.mdse.minisql.schema.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ColumnItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchemaPackage.Literals.COLUMN__TYPE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Column.class)) {
			case SchemaPackage.COLUMN__TYPE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.COLUMN__TYPE,
				 TypesFactory.eINSTANCE.createIntegerType()));

		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.COLUMN__TYPE,
				 TypesFactory.eINSTANCE.createBooleanType()));

		newChildDescriptors.add
			(createChildParameter
				(SchemaPackage.Literals.COLUMN__TYPE,
				 TypesFactory.eINSTANCE.createStringType()));
	}
