		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnReference_column_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnReference_column_feature", "_UI_ColumnReference_type"),
				 QueryPackage.Literals.COLUMN_REFERENCE__COLUMN,
				 true,
				 false,
				 true,
				 null,
