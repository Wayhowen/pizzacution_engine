 ...
 * @generated
 */
public class FromClauseItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QueryPackage.Literals.FROM_CLAUSE__TABLE_REFERENCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FromClause.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QueryPackage.Literals.FROM_CLAUSE__TABLE_REFERENCE,
				 QueryFactory.eINSTANCE.createTableReference()));
	}
