 ...
 * @generated
 */
public class ComparativeExpressionItemProvider extends BinaryItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComparativeExpression_operator_feature", "_UI_ComparativeExpression_type"),
				 QueryPackage.Literals.COMPARATIVE_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComparativeExpression_type") :
