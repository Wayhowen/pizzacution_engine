 ...
 * @generated
 */
public class SelectQueryItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QueryPackage.Literals.SELECT_QUERY__WHAT_CLAUSE,
				 QueryFactory.eINSTANCE.createWhatClause()));

		newChildDescriptors.add
			(createChildParameter
				(QueryPackage.Literals.SELECT_QUERY__FROM_CLAUSE,
				 QueryFactory.eINSTANCE.createFromClause()));

		newChildDescriptors.add
			(createChildParameter
				(QueryPackage.Literals.SELECT_QUERY__WHERE_CLAUSE,
				 QueryFactory.eINSTANCE.createWhereClause()));

		newChildDescriptors.add
			(createChildParameter
				(QueryPackage.Literals.SELECT_QUERY__ORDER_BY_CLAUSE,
