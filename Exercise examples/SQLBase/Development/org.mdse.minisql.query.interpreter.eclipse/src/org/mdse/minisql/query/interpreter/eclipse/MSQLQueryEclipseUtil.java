package org.mdse.minisql.query.interpreter.eclipse;
...
public class MSQLQueryEclipseUtil {
	public static EObject loadModel(IFile fsmFile) {
		IPath fullPath = fsmFile.getFullPath();
