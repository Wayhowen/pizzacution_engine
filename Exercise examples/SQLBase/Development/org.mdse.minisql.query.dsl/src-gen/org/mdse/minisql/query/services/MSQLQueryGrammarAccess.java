...
public class MSQLQueryGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OrderDirectiveElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDirectionOrderDirectionEnumRuleCall_1_0 = (RuleCall)cDirectionAssignment_1.eContents().get(0);
		
		//OrderDirective:
		//	columnReference=ColumnReference
		//	//	(ascending?=ORDER_DIRECTION)?
		//	direction=OrderDirection?;
		@Override public ParserRule getRule() { return rule; }
		
		//columnReference=ColumnReference //	(ascending?=ORDER_DIRECTION)?
		//direction=OrderDirection?
		public Group getGroup() { return cGroup; }
		...
		//OrderDirection
		public RuleCall getDirectionOrderDirectionEnumRuleCall_1_0() { return cDirectionOrderDirectionEnumRuleCall_1_0; }
	}
	...
	public class OrderDirectionElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.mdse.minisql.query.MSQLQuery.OrderDirection");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final Keyword cASCENDINGASCKeyword_0_0 = (Keyword)cASCENDINGEnumLiteralDeclaration_0.eContents().get(0);
		...
		private final Keyword cDESCENDINGDESCKeyword_1_0 = (Keyword)cDESCENDINGEnumLiteralDeclaration_1.eContents().get(0);
		...
		//"ASC"
		public Keyword getASCENDINGASCKeyword_0_0() { return cASCENDINGASCKeyword_0_0; }
		
		//DESCENDING="DESC"
		public EnumLiteralDeclaration getDESCENDINGEnumLiteralDeclaration_1() { return cDESCENDINGEnumLiteralDeclaration_1; }
		
		//"DESC"
		public Keyword getDESCENDINGDESCKeyword_1_0() { return cDESCENDINGDESCKeyword_1_0; }
	}
	...
	private final OrderDirectionElements eOrderDirection;
	...
	private final MSQLTypesGrammarAccess gaMSQLTypes;
	
	private final TerminalsGrammarAccess gaTerminals;

	@Inject
	public MSQLQueryGrammarAccess(GrammarProvider grammarProvider,
			MSQLTypesGrammarAccess gaMSQLTypes,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaMSQLTypes = gaMSQLTypes;
		...
		this.eOrderDirection = new OrderDirectionElements();
		...
		this.tBOOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.mdse.minisql.query.MSQLQuery.BOOL");
	}
	...
	public MSQLTypesGrammarAccess getMSQLTypesGrammarAccess() {
		return gaMSQLTypes;
	}
	...
	//enum OrderDirection:
	//	ASCENDING="ASC" | DESCENDING="DESC";
	public OrderDirectionElements getOrderDirectionAccess() {
		return eOrderDirection;
	}
	
	public EnumRule getOrderDirectionRule() {
		return getOrderDirectionAccess().getRule();
	}
	...
	public MSQLTypesGrammarAccess.TypeElements getTypeAccess() {
		return gaMSQLTypes.getTypeAccess();
	}
	...
	//IntegerType:
	//	"Int" {IntegerType};
	public MSQLTypesGrammarAccess.IntegerTypeElements getIntegerTypeAccess() {
		return gaMSQLTypes.getIntegerTypeAccess();
	}
	...
	//StringType:
	//	"String" {StringType};
	public MSQLTypesGrammarAccess.StringTypeElements getStringTypeAccess() {
		return gaMSQLTypes.getStringTypeAccess();
	}
	...
	//BooleanType:
	//	"Bool" {BooleanType};
	public MSQLTypesGrammarAccess.BooleanTypeElements getBooleanTypeAccess() {
		return gaMSQLTypes.getBooleanTypeAccess();
	}
