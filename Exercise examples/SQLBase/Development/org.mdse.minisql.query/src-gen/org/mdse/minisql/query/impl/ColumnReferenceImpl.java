...
public class ColumnReferenceImpl extends ExpressionImpl implements ColumnReference {
		...
		if (column != null && column.eIsProxy()) {
			...
			if (column != oldColumn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QueryPackage.COLUMN_REFERENCE__COLUMN, oldColumn, column));
			}
		}
		return column;
	}
	...
	public void setColumn(Column newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.COLUMN_REFERENCE__COLUMN, oldColumn, column));
	}
	...
	@Override
	public Type getType() {
		return column == null ? org.mdse.minisql.types.TypesFactory.eINSTANCE.createUndefinedType() : column.getType();
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QueryPackage.COLUMN_REFERENCE___GET_TYPE:
				return getType();
		}
