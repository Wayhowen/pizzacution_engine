 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.minisql.query.impl.LogicalExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LogicalExpressionImpl extends ExpressionImpl implements LogicalExpression {
	/**
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.LOGICAL_EXPRESSION;
	}
	...
	public void setOperator(LogicalOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.LOGICAL_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.LOGICAL_EXPRESSION__OPERATOR:
				return getOperator();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QueryPackage.LOGICAL_EXPRESSION___GET_TYPE:
				return getType();
		}
