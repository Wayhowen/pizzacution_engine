 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.minisql.query.impl.ArithmeticExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArithmeticExpressionImpl extends BinaryImpl implements ArithmeticExpression {
	/**
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.ARITHMETIC_EXPRESSION;
	}
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.ARITHMETIC_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	@Override
	public Type getType() {
		return org.mdse.minisql.types.TypesFactory.eINSTANCE.createIntegerType();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseOperationID) {
				case TypesPackage.TYPED_ELEMENT___GET_TYPE: return QueryPackage.ARITHMETIC_EXPRESSION___GET_TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QueryPackage.ARITHMETIC_EXPRESSION___GET_TYPE:
				return getType();
		}
