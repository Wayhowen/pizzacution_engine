 ...
 * @generated
 */
public class ComparativeExpressionImpl extends BinaryImpl implements ComparativeExpression {
	/**
	...
	public void setOperator(ComparativeOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.COMPARATIVE_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseOperationID) {
				case TypesPackage.TYPED_ELEMENT___GET_TYPE: return QueryPackage.COMPARATIVE_EXPRESSION___GET_TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QueryPackage.COMPARATIVE_EXPRESSION___GET_TYPE:
				return getType();
		}
