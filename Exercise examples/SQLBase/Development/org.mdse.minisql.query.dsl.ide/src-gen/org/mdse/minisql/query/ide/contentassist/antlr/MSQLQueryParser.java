...
public class MSQLQueryParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MSQLQueryGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOrderDirectionAccess().getAlternatives(), "rule__OrderDirection__Alternatives");
			...
			builder.put(grammarAccess.getOrderDirectiveAccess().getDirectionAssignment_1(), "rule__OrderDirective__DirectionAssignment_1");
